...
class MRERawEvent : public MRESE, public MRotationInterface
{
 ...
 public:
  ...
  static const int c_RejectionEventClusteringTooManyHits    = 27;
  static const int c_RejectionTooManyEventIncarnations      = 28;
  static const int c_RejectionEventClusteringUnresolvedHits = 29;
  static const int c_RejectionEventClusteringNoOrigins      = 30;
